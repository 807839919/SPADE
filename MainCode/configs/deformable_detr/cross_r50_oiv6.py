_base_ = ["../_base_/datasets/oiv6.py", "../_base_/custom_runtime.py"]

num_object_classes = 601
num_relation_classes = 31
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            "object_transformer": dict(lr_mult=0.1),
...
# load_from = None
load_from = "/home/jhwang/pretrain/deformable_clean.pth"
