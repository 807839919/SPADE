...
# 设置 TORCH_DISTRIBUTED_DEBUG 环境变量为 DETAIL
os.environ['TORCH_DISTRIBUTED_DEBUG'] = 'DETAIL'

import mmcv
import torch
import torch.distributed as dist
from mmcv.parallel import MMDistributedDataParallel as MMDP
...
from mmdet.utils import (collect_env, get_device, get_root_logger,
                         ...
                         update_data_root)
from pairnet.datasets import build_dataset
...
def main():
    ...
    # cfg.find_unused_parameters = distributed
    # create work_dir
    ...
    if distributed:
        ...
        model = MMDP(model, device_ids=[local_rank], broadcast_buffers=False, find_unused_parameters=True)
    else:
