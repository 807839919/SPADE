...
custom_imports = dict(
    imports=[
        ...
        "reldiff.models.frameworks.psgtr_transformer",
        "reldiff.models.losses.seg_losses",
        "reldiff.models.relation_heads.psgtr_head",
        "reldiff.models.relation_heads.reldiff",
        "reldiff.datasets",
...
model = dict(
    ...
    bbox_head=dict(type='reldiffHead',
...
project_name = "psgtr_sd"
expt_name = "psgtr_sd_r50_psg_0.5_scale_mask"
...
load_from = "work_dirs/checkpoints/detr_pan_r50.pth"  #'/home/jkyang/reldiff/work_dirs/hoitr4sg_r50_psg_full/epoch_150.pth'

# load_from = 'work_dirs/checkpoints/psgtr_mask_trial.pth'
#resume_from = 'work_dirs/psgtr_r50_psg_0.5_scale_mask/latest.pth'
